...
public class FileUploadService {
	...
	public static String fileUpload(byte[] imagen) throws IOException {
	...
	public static String convertBytesToEncoded(byte[] image){
